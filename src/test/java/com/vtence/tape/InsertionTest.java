...
public class InsertionTest {
    ...
    @Test public void
    insertsNewRecordsWithCompleteColumnInformation() throws Exception {
        ...
        assertThat("record", record, samePropertyValuesAs(original));
    }

    @Test public void
    updatesEntityWithGeneratedKeysAfterInsertion() throws Exception {
